...
2. Используйте `pip install -r requirements.txt` для установки зависимостей.

## Запуск
1. Напишите `python browser.py` в корне репозитория, чтобы запустить программу.
2. Введите адрес сайта в открывшейся программе.
